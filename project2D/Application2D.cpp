...
void Application2D::draw() 
{
	...
	for (int i = 0; i < 5; i++)
	{
		if (mEnemy[i].noCrash)
		{
			...
			m_2dRenderer->drawBox(mEnemy[i].mPos.mX, mEnemy[i].mPos.mY, mEnemy[i].mScale.mX, mEnemy[i].mScale.mY);
		}
